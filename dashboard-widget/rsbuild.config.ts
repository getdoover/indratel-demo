...
const mfConfig = createModuleFederationConfig({
    ...
    // Nothing consumes this widget's types, and the generator chokes on the
    // `customer_site/*` remotes it can't resolve at build time.
    dts: false,
    remotes: {
    ...
    exposes: {
        './IndratelDemoWidget': './src/IndratelDemoWidget',
    },
    shared: {
